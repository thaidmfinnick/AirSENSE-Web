var a='Welcome to my website Nguyen Ngoc Quyen'
alert(a)
...
function convertLbs(){
	...
	if (!input){
		...
		kgsOutput.textContent = Math.floor((input * 0.45359237) * 10000) / 10000;
