...
const TABLE_NAME = 'status_history_device';
 ...
 * User model.
 */
class StatusHistoryDevice extends CommonModel {
  /**
   * Get table name.
   */
  get tableName() {
...
/*
  ...
  getFieldToAdd(){
      return {
          valueSetup: ["deviceid","content","note"]
      };
  }
  getFieldToDelete(){
      return {
          arrayCoppy:["deviceid","content","note","created_at","id_created"],
          locationSelect:"id",
...
module.exports =  StatusHistoryDevice;
