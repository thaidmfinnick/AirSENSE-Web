...
const TABLE_NAME = 'pages_content';
...
/*
  ...
  getFieldToAdd(){
      return {
          valueSetup: ["group_content_sub_id","group_file","filesave","title","content","content_img","is_main_pages_id","set_to_fist"]
      };
  }
  getFieldToDelete(){
      return {
          arrayCoppy:["group_content_sub_id","group_file","filesave","title","content","content_img","is_main_pages_id","set_to_fist","created_at","id_created"],
