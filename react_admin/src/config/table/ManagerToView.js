...
import GroupService from './GroupService.table';
...
const classesFactory = {User_View ,Adress,DecentralizationAccess,GroupContent,
    ...
    ,BuyProduct,BackProduct,ReturnService ,ChargingService ,Service,GroupContentSub,GroupService};
const classesFactorryMapping = {  users:"User_View", adress:"Adress" ,
                                ...
                                service:"Service",group_content_sub:"GroupContentSub",group_service:"GroupService" };   
