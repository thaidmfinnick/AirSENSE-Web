...
import { uploadfileDataImage,registerPageToWriter ,updatePageToWriter} from '../../api/httpBaseUtil.js';
...
class RegisterPage extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = {
            pages_content_id:this.props.is_update?this.props.data.pages_content_id :0,
    ...
    onChangeSub(content,detail){
        ...
        ManagerData.getLstDataPromise('pages_content',{dataFind:{ group_content_sub_id:content.target.value,is_main_pages_id:-1 }} ).then(()=>{
            this.setState({ refesh:false});
            setTimeout(()=>{
                this.setState({ refesh:true});
            },200);
            ...
            <div className="user-data">
                ...
                <div className={'row-register'} >
                    ...
                    <div className={'column-register-right'} >
                        ...
                        <br/>
                        Nội dung bài viết
                        <TextField variant="outlined"  value={this.state.title}  onChange={(event) => {
                                                                                    this.onChangTitle(event);
                                                                                }} />
                        Mô tả cụ thê
                        <TextField variant="outlined" value={this.state.content}  onChange={(event) => {
